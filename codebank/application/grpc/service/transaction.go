...
func (s *TransactionService) Payment(ctx context.Context, in *pb.PaymentRequest) (*empty.Empty, error) {
	...
	transaction, err := s.ProcessTransactionUseCase.ProcessTransaction(transactionDto)
	if err != nil {
